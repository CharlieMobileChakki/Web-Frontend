...
import { AdminCreateDriver } from "../../../services/NetworkServices";
...
const CreateDriver = () => {
    ...
    const [files, setFiles] = useState({
        driverAdharUpload: null,
        driverPanUpload: null,
        driverLicenseUpload: null,
        employmentCertificateUpload: null,
        employmentOfficialDocsUpload: null,
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await AdminCreateDriver(submissionData);
            ...
            toast.error("Error creating driver. Please check your inputs.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-lg shadow p-8">
                <h2 className="text-2xl font-bold mb-6 text-gray-800">Create New Driver</h2>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="border-t pt-4">
                        <h3 className="text-lg font-semibold mb-4 text-gray-700">Documents Upload</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
